...
class CanalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create canal" do
    assert_difference('Canal.count') do
      post canals_url, params: { canal: { image: @canal.image, name: @canal.name, state: @canal.state } }
    end
  ...
  test "should update canal" do
    patch canal_url(@canal), params: { canal: { image: @canal.image, name: @canal.name, state: @canal.state } }
